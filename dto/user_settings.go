...
type UserSetting struct {
	...
	PlaygroundApplyPromptToRealAPI      *bool          `json:"playground_apply_prompt_to_real_api,omitempty"`
	PlaygroundApplyModelConfigToRealAPI *bool          `json:"playground_apply_model_config_to_real_api,omitempty"`
}
