...
func InitOptionMap() {
	...
	common.OptionMap["ModelConsumeRatio"] = ratio_setting.ModelConsumeRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelConsumeRatio":
		err = ratio_setting.UpdateModelConsumeRatioByJSONString(value)
	case "GroupRatio":
