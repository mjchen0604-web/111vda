...
class CompatSessionRouteTests(unittest.TestCase):
    ...
    def test_chat_completions_keeps_full_history_by_default(self):
        calls = []
    ...
    def test_anthropic_messages_keep_full_history_by_default(self):
        calls = []
    ...
    def test_ollama_chat_keeps_full_history_by_default(self):
        calls = []
