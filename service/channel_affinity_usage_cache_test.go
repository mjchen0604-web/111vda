...
func nextChannelAffinityUsageTestKey(prefix string) string {
	return fmt.Sprintf("%s_%d", prefix, atomic.AddUint64(&channelAffinityUsageCacheTestCounter, 1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := nextChannelAffinityUsageTestKey("rule")
	usingGroup := "default"
	keyFP := nextChannelAffinityUsageTestKey("fp")
